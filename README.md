...
# Responsive Web Design Certification #13 | Piano

## 1️⃣ Objetivo
Desenvolver um teclado de piano responsivo, onde a quantidade de teclas visíveis (brancas e pretas) se ajusta automaticamente ao tamanho da tela.

## 2️⃣ Descrição
Este é o 13º curso da trilha **Responsive Web Design Certification**, com foco no conceito de *Responsive Design*.

A proposta deste curso é mostrar, de forma prática, como criar páginas que se adaptam perfeitamente a diferentes tamanhos de tela, garantindo uma experiência agradável para os usuários, independentemente do dispositivo.
